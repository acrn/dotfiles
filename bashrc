...
# fix tmux woes
alias ssh='TERM=screen ssh' # TODO: Is this needed?
...
#     . ~/.bash_aliases
# fi
alias ack='ACK_PAGER_COLOR="less -RFX" ack'
...
function git-ticket { git log | awk -v v_id="#$1" '/^commit/{commit=$2;}($0 ~ v_id){print commit;}' | uniq; }
